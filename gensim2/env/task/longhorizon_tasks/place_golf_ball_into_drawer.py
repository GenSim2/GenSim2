...
class PlaceGolfBallIntoDrawer(GenSimBaseTask):
    """Place the golf ball into the drawer."""

    def __init__(self, env, asset_id=""):
        # self.task_description = "Place the golf ball into the drawer"
        self.task_description = "Open the drawer, pick and place the golf ball into the drawer, and close the drawer."
        self.sub_tasks = [
            "OpenDrawer",
            "ReachBall",
            "Grasp",
        ...
        super().__init__(
            env, articulator="drawer", rigid_body="golf_ball", asset_id=asset_id
        )
