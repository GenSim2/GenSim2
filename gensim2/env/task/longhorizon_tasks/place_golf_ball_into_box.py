...
class PlaceGolfBallIntoBox(GenSimBaseTask):
    def __init__(self, env, asset_id=""):
        self.task_description = "Open the box, pick and place the golf ball into the box, and close the box."
        self.sub_tasks = [
            "OpenBox",
            "ReachRigidBody",
            "Grasp",
        ...
        super().__init__(
            env, articulator="box_rotate", rigid_body="golf_ball", asset_id=asset_id
        )
