...
class PlaceLemonIntoDrawer(GenSimBaseTask):
    def __init__(self, env, asset_id=""):
        self.task_description = "Open the drawer, pick and place the lemon into the drawer, and close the drawer."
        self.sub_tasks = [
            "OpenDrawer",
            "ReachRigidBody",
            "Grasp",
        ...
        super().__init__(
            env, articulator="drawer", rigid_body="lemon", asset_id=asset_id
        )
