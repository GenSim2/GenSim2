...
class PlaceCrackerBoxIntoDrawer(GenSimBaseTask):
    """Open the drawer, pick and place the cracker box into the drawer, and close the drawer."""

    def __init__(self, env, asset_id=""):
        self.task_description = "Open the drawer, pick and place the cracker box into the drawer, and close the drawer."
        self.sub_tasks = [
            "OpenDrawer",
            "ReachCuboid",
            "Grasp",
        ...
        super().__init__(
            env, articulator="drawer", rigid_body="cracker_box", asset_id=asset_id
        )
