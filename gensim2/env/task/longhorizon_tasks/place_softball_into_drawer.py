...
class PlaceSoftBallIntoDrawer(GenSimBaseTask):
    def __init__(self, env, asset_id=""):
        self.task_description = "Open the drawer, pick and place the softball into the drawer, and close the drawer."
        self.sub_tasks = [
            "OpenDrawer",
            "ReachBall",
            "Grasp",
        ...
        super().__init__(
            env, articulator="drawer", rigid_body="softball", asset_id=asset_id
        )
