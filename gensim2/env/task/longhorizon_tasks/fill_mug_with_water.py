...
class FillMugWithWater(GenSimBaseTask):
    """Open the microwave door, place the cracker box inside, and close the door."""

    def __init__(self, env, asset_id=""):
        # self.task_description = "Place the cracker box inside the microwave."
        self.task_description = "Pick and place the mug under the faucet, turn on the faucet, and turn off the faucet"
        self.sub_tasks = [
            "ReachRigidBody",
            "Grasp",
            "MoveUnderFaucet",
        ...
        self.sub_task_descriptions = [
            "Reach the object from a horizontal direction",
            "Close the gripper",
            "Move the gripper under the faucet",
            "Open the gripper",
            "Turn on the faucet",
            "Turn off the faucet",
        ]
        ...
        super().__init__(env, articulator="faucet", rigid_body="mug", asset_id=asset_id)
