...
from vec_env.maniskill2_vec_env import PointCloudVecEnv, RGBDVecEnv, VecEnv
from vec_env.maniskill2_wrapper_obs import VecRobotSegmentationObservationWrapper
...
def make(
    ...
    **kwargs,
    ...
    from maniskill2_utils_registration import REGISTERED_ENVS
