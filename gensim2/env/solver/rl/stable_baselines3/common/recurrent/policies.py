...
import numpy as np
import torch as th
from gensim2.env.solver.rl.stable_baselines3.common.distributions import Distribution
...
from gensim2.env.solver.rl.stable_baselines3.common.type_aliases import Schedule
from gensim2.env.solver.rl.stable_baselines3.common.utils import zip_strict
...
class RecurrentActorCriticPolicy(ActorCriticPolicy):
    ...
    def predict(
        ...
        with th.no_grad():
            ...
            states = th.tensor(state[0]).float().to(self.device), th.tensor(
                state[1]
