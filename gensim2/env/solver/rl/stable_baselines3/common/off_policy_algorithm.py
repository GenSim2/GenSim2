...
from gensim2.env.solver.rl.stable_baselines3.common.base_class import BaseAlgorithm
...
from gensim2.env.solver.rl.stable_baselines3.common.noise import (
    ActionNoise,
...
from gensim2.env.solver.rl.stable_baselines3.her.her_replay_buffer import (
    HerReplayBuffer,
)
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _dump_logs(self) -> None:
        ...
        fps = int(
            (self.num_timesteps - self._num_timesteps_at_start) / (time_elapsed + 1e-8)
        )
