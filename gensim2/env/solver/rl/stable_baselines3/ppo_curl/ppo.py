...
class CURL(nn.Module):
    ...
    def __init__(
        self, z_dim, batch_size, encoder, encoder_target, output_type="continuous"
    ):
...
class PPO(OnPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        self.target_features_extractor.load_state_dict(
            self.policy.features_extractor.state_dict()
        )

        self.curl_optimizer = th.optim.Adam(
            self.CURL.parameters(), lr=self.learning_rate
        )
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                curl_loss = self.get_curl_loss(
                    rollout_data.observations, rollout_data.next_observations[1]
                )
