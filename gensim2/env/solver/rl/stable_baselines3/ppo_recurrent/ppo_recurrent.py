...
from gensim2.env.solver.rl.stable_baselines3.common.policies import BasePolicy
...
from gensim2.env.solver.rl.stable_baselines3.common.vec_env import VecEnv

from gensim2.env.solver.rl.stable_baselines3.common.recurrent.buffers import (
    RecurrentDictRolloutBuffer,
    RecurrentRolloutBuffer,
)
from gensim2.env.solver.rl.stable_baselines3.common.recurrent.policies import (
    RecurrentActorCriticPolicy,
)
from gensim2.env.solver.rl.stable_baselines3.common.recurrent.type_aliases import (
    RNNStates,
)
from gensim2.env.solver.rl.stable_baselines3.ppo_recurrent.policies import (
    CnnLstmPolicy,
    MlpLstmPolicy,
...
class RecurrentPPO(OnPolicyAlgorithm):
    ...
    policy_aliases: Dict[str, Type[BasePolicy]] = {
        ...
        "PointNetLstmPolicy": RecurrentActorCriticPolicy,  # == MlpLstmPolicy. The PointNetExtractor is passed in through policy_kwargs(features_extractor_class)
    ...
    def collect_rollouts(
        ...
        # borrowed from on_policy_algorithm.py
